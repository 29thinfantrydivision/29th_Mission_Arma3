 ...
 *
 * Description:
 *   Registers the "!radio" admin chat command. Displays the
 *   encryption codes for the player's active SW radio, backpack
 *   LR radio, and vehicle LR radio via side chat.
 *
 * Parameters:
