/**
 * File: XEH_preInit.sqf (radio)
 * Author: Bae [29th ID]
 *
 * Description:
 *   Registers CBA settings for the radio module during the
 *   CBA Extended Event Handler pre-init phase. Settings control
 *   SR radio auto-assignment, radio removal on death, and
 *   forcing vehicle LR to the player's side.
 *
 * Parameters:
 *   None
 *
