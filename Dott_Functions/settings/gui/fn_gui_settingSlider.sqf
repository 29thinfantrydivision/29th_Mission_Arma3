...
/**
 * Formats a numeric value as display text for the
 * edit box, handling percentage mode and rounding.
 * Shared by all three event handlers and initial setup.
 */
...
_ctrlSlider setVariable [
    "cba_settings_params",
    [_setting, _source, _trailingDecimals, _isPercentage]
];
...
_ctrlSliderEdit ctrlAddEventHandler [
    "KeyUp",
    {
        ...
        // Clamp via the slider's own range.
...
// --- Focus-lost: re-format the text cleanly ---
_ctrlSliderEdit ctrlAddEventHandler [
    "KillFocus",
    {
        params ["_ctrlSliderEdit"];
