...
/*
 * Function: DOTT_round XEH_preInit
 *
 * Description:
 *     Registers CBA settings for the round module. Initializes
 *     disableRespawnScoreboard before the scoreboard setting callback
 *     can reference it.
 *
 * Parameters:
 *     None
...
// Must be initialized before the TN_disableScoreboard callback
// references it in removeMissionEventHandler.
