 ...
 *
 * Description:
 *     Adds (or subtracts) time from the currently running round.
 *     Cannot be used when no round is active. Notifies all players
 *     of the time change via hint.
 *
 * Parameters:
 *     _timeDelta <Number> - Seconds to add. Negative values
 *                           subtract time.
 *
 * Returns:
