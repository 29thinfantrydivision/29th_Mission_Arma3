 ...
 *
 * Description:
 *     Starts the round with a specified timer length. Displays a
 *     LIVE notification, kicks off the countdown, schedules the
 *     end-of-round check, fires the round_started event, and
 *     clears safe start state.
 *
 * Parameters:
