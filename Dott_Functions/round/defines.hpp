/*
 * File: defines.hpp (round module)
 *
 * Description:
 *     Preprocessor constants and utility macros for the round
 *     management module. Defines default timer/overtime durations,
 *     score manipulation values, and state reset macros.
 */
