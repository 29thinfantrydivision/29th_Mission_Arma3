 ...
 *     Configures scoreboard blocking during active rounds, wires up
 *     final checks for player invulnerability and the silent weapon
 *     bug, and ensures the countdown UI layer exists.
 *
 * Parameters:
 *     None
 *
