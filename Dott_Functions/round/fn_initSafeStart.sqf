 ...
 *     notification and delegates to the helper function which polls
 *     until the timer expires or teams unready. If _forced is true,
 *     the countdown ignores team readiness state.
 *     Forced to run on server.
 *
 * Parameters:
 *     _safeStartTime <Number>  - Seconds between all sides ready
 *                                and automatic live call.
 *                                Default: TN_safeStartTime
 *     _forced        <Boolean> - Force safe start regardless of
 *                                team readiness. Default: false
 *
 * Returns:
