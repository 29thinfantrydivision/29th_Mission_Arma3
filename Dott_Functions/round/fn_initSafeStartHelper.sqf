 ...
 *
 * Description:
 *     Helper function for initSafeStart. Polls every 0.2 seconds
 *     until the safe start countdown expires (then starts the round)
 *     or until teams are no longer all ready and forced mode is off
 *     (then aborts the countdown).
 *
 * Parameters:
 *     None
 *
