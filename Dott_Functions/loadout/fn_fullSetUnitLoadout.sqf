...
isNil { [_unit, _loadout, _fullMagazines] call CBA_fnc_setLoadout };

// Holster if unit has no primary weapon.
...
// Wait for weapon reset to finish before applying insignia,
// otherwise setInsignia may incorrectly detect a non-combat loadout.
