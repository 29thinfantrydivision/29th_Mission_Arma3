/**
 * CfgFunctions.hpp
 * Purpose: Function library registration for all DOTT modules.
 *          Included inside CfgFunctions in description.ext.
 *          Each class registers a tag and maps function files from
 *          the corresponding Dott_Functions subfolder.
