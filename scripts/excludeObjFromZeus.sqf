...
curatorExcludedObjects = [] spawn {
	...
	_ex_zeus_modules = [zeus_admin,zeus_ltc,zeus_maj,zeus_msgt,zeus_co,zeus_snco,zeus_cs,zeus_plt1_pl,zeus_plt1_ps1,zeus_plt1_ps2,zeus_plt2_pl,zeus_plt2_ps,zeus_red_plt,zeus_red_1_plt,zeus_grn_plt,zeus_grn_1_plt];
